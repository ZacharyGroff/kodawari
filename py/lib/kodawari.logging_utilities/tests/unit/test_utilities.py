...
def test_get_logger() -> None:
    ...
    with (
        patch("logging_utilities.utilities.logging.Formatter") as formatter_mock,
        patch(
            "logging_utilities.utilities.logging.StreamHandler"
        ) as stream_handler_mock,
        patch("logging_utilities.utilities.logging.getLogger") as get_logger_mock,
    ):
        ...
        actual_logger: logging.Logger = get_logger(expected_name, expected_log_level)
        ...
        assert expected_handler.set_formatter_called_with[0] == expected_formatter
